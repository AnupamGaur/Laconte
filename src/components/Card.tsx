...
const Card = (
  ...
  const { color = "fuchsia", children, className, buttontext } = props;
  return (
    <div className={twMerge("relative z-0 p-8 md:p-10 group", className)}>
      <div
        className={twMerge(
          "absolute -z-10 bg-fuchsia-500 size-16 top-1.5 right-1.5 rounded-xl opacity-0 blur-lg group-hover:opacity-100 transition duration-300",
      ...
      <div
        className={twMerge(
          "absolute -z-10 bg-fuchsia-500 size-16 top-1.5 right-1.5 rounded-xl opacity-100 group-hover:bg-fuchsia-400",
